...
#abakus_data_n<- read.table(file_name[n], skip=6, sep="\t", dec=",", header=TRUE)
...
#Always remember to change the lty of the plotted lines together with the lty of the legend